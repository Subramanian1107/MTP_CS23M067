...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        model = AutoModelForCausalLM.from_config(config, trust_remote_code=model_args.trust_remote_code,ignore_mismatched_sizes=True, torch_dtype=torch_dtype)
    ...
    print(type(tokenizer))  # Check what type tokenizer is
    print(tokenizer)
